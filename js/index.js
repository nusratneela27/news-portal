...
const showCatagories = (data) =>{
    ...
    data.news_category.forEach(singleCatagories => {
        ...
        linkContainer.innerHTML = `<a class="nav-link" href="#" onclick = "fetchCategoriesNews('${singleCatagories.category_id}' , '${singleCatagories.category_name}')">${singleCatagories.category_name}</a>`;
